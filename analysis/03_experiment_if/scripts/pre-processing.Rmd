---
title: "Pre-processing for Replication of Larralde et Noveck (in prep) with If-Training"
author: Morgan Moyer
date: 13 June 2023
...
```{r}
length(unique(d$ID)) # 95 subjects because unnecessary columns are being 
