...
d.rt1.grand <- read.csv("../data/rt1_processed_grandsd.csv")
```
...
d.rt1.grand$Connective = as.factor(d.rt1.grand$Connective)
d.rt1.grand$ID = as.factor(d.rt1.grand$ID)
d.rt1.grand$TrialID = as.factor(d.rt1.grand$TrialID)
d.rt1.grand$ReactionTime1 = as.numeric(d.rt1.grand$ReactionTime1)
d.rt1.grand$LogRT1 = log(d.rt1.grand$ReactionTime1)
...
m.rt1 = lmer(ReactionTime1 ~ Connective + (1+Connective|ID) + (1|TrialID), data=d.rt1.grand)
summary(m.rt1)
...
- not sognificant
```{r}
m.log.rt1 = lmer(LogRT1 ~ Connective + (1+Connective|ID) + (1|TrialID), data=d.rt1)
summary(m.log.rt1)
