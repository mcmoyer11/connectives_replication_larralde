...
Template("warm_up_1.csv",
    row => newTrial("warmup1",
        ...
        newText("space", "<br>")
            .print()
        ,
        newText("space", "<br>").print(), newText("space", "<br>").print(),
        newText("space", "<br>").print(), newText("space", "<br>").print(),
        newText("space", "<br>").print(), newText("space", "<br>").print(),
        newText("space", "<br>").print(), newText("space", "<br>").print()
        ,
        ...
        getImage("cross")
            .remove()
        ,
        newText("one", row.Screen1).settings.css("font-size", "70")
            .print()
        ,
        newTimer("wait", 1100)
            .start()
        ...
        getVar("RT3")
            .set(v => Date.now() - v)//.log( "ReactionTime" , getVar("RT4"))
        ,
        getText("three")
            .remove()
        ,
...
Template("warm_up_2.csv",
    row => newTrial("warmup2",
        ...
        newText("space", "<br>").print(), newText("space", "<br>").print(), newText("space", "<br>").print(),
        newText("space", "<br>").print(), newText("space", "<br>").print(), newText("space", "<br>").print(),
        newText("space", "<br>").print(), newText("space", "<br>").print(), newText("space", "<br>").print()
        ,
        newImage("cross", "cross.png")
