newTrial( "Consent" ,
    newText("Please click on the link below to read our information sheet.")
            ...
            .print()
    ,
    newText("<br><a href='https://drive.google.com/file/d/1zUgXRVJW_GxeNo4TVp1o5qydarS_Srz7/view?usp=sharing' target='_blank'> Information sheet </a>")
        .center()
        .print()
    ,
    newText("<br> ").center().color("red")
        .print()
    ,
...
newTrial("Participantid",
    newVar("ParticipantName")
        .global()
    ,
    newText("Before we start can you please provide us with the following information.")
        .center()
        .print()
    ,
    ...
    newTextInput()
        .center()
        .print()
        .wait()                 // The next command won't be executed until Enter is press 
...
newTrial("Questionsparticipant",
    ...
    newTextInput("Age")
        .before(
            newText("<br>Please enter your age and press ENTER : ")
                .center()
                .print()
        )
        .center()
